...
class BaseAnimateWindow : public Window
{
public: 
	BaseAnimateWindow();
	BaseAnimateWindow(string _fileName, ID3D11Device* _GD, string _windowName, bool render, XMVECTORF32 _colour);
	virtual ~BaseAnimateWindow();
